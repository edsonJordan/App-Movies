                    ...
                    <div className={style.logo}>            
                        <svg viewBox="0 0 24 24" className={style.svg__logo}  xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                            ...
                            <style type="text/css">
                                ...
                                <defs>
                                    <linearGradient id="MyGradient" att="next">
                                    <stop offset="0%" stop-color="rgba(230, 0, 115, .6)" />
                                    <stop offset="25%" stop-color="rgba(230, 0, 115, .8)" />
                                    <stop offset="45%" stop-color="rgba(230, 0, 115, 1)" />
                                    <stop offset="65%" stop-color="rgba(230, 0, 115, .8)" />
                                    <stop offset="95%" stop-color="rgba(230, 0, 115, .6)" />
                                    </linearGradient>
                                </defs> */}
